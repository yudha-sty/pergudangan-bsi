                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>HeadPhone</td>
                                            <td><img src="{{url ('template/dist/assets/images/widget/p1.jpg') }}" alt="" class="img-20"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Iphone 6</td>
                                            <td><img src="{{url ('template/dist/assets/images/widget/p2.jpg') }}" alt="" class="img-20"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Jacket</td>
                                            <td><img src="{{url ('template/dist/assets/images/widget/p3.jpg') }}" alt="" class="img-20"></td>
                                            <td>
